...
while True:
    ...
    print("\n" + "="*40)
    print("О программе - 1. Основные данные - 2. Инвентарь - 3. Персонажи - 4. Путь прохождения - 5.")
    ...
    if rezhim=="1":
        print("UnSa - Программа для изменения данных внутри сохранения Undertale. Версия:1.2. Создано Chitora (https://www.youtube.com/@ChitoraMusic). Связаться со мной:chitoramusic (Discord). Исходный код:https://github.com/cucuberstwo-commits/UnSa")
        ...
        print("Геноцид - 1. Пацифист - 2.")
        
        viboru = input("Выберите, на какую концовку вы идете:")
