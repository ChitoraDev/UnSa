		...
		if (!(std::cin >> Isn)) {
			...
			if (!(std::cin >> setfun)) {
    			...
    			system(OpnConFol.c_str());
					...
					std::cout << "..........[Version: 2 Beta 2].........." << std::endl;
			...
			std::cout << "..[Select function].." << std::endl;
			std::cout << "..[Export - 1. Delete - 2. Clear - 3. Fix - 4. 5 - Read].." << std::endl;     //no import
			...
			if (!(std::cin >> SVF)) {
					...
					std::cout << "In development cuz its so hard" << std::endl << std::endl;
					...
					chtenie ("Your human is located", 547);

					chtenie ("For attack you use", 28); //create a fucn for humanity output

					chtenie ("For defeat you use", 29); //create a fucn for humanity output
